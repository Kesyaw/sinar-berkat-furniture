      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-auto space-y-3">
            {isReady ? (
              <AddToCartButton product={{ id: product.id, name: product.name, basePrice: product.basePrice, imageUrl: imageUrl }} />
            ) : (
            ...
            <a href={"https://wa.me/" + WA_NUMBER + "?text=" + encodeURIComponent(waMessage)} target="_blank" rel="noopener noreferrer" className="block w-full border border-stone-300 text-stone-700 text-center py-3 rounded-xl font-semibold hover:bg-stone-50 transition text-sm">Tanya via WhatsApp</a>
